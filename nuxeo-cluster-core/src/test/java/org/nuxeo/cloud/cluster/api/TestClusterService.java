...
public class TestClusterService {
    ...
    @Test
    public void can_inject_the_cluster_service() {
        assertNotNull(clusterservice);
    }

    @Test
    public void can_get_a_map_from_the_service() throws Exception {
        Map<String, String> map1 = clusterservice.getMap("mymap");
        assertThat(map1).isNotNull();
        map1.put("john", "doe");

        Map<String, String> map2 = clusterservice.getMap("mymap");
        assertThat(map2).containsEntry("john", "doe");

        map2 = clusterservice.getMap("myothermap");
        assertThat(map2).doesNotContainEntry("john", "doe");
